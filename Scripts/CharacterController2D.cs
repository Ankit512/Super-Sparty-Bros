...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // if can double jump and the jump button is pressed allow the player to double jump
        {
            doJump();
            _canDoubleJump = false; // double jump can only be done once
        }
